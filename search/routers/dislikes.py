...
def build_dislikes_router(
    *,
    ...
    invalidate_for_you: Callable[[], None] | None = None,
) -> APIRouter:
    ...
    async def list_dislikes(
        ...
        # No upper cap on limit — Dislikes albums can grow arbitrarily
